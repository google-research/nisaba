...
def _typ_to_txn() -> p.Fst:
  ...
  assign_phoneme_vocalic = p.union(
  ...
  assign_phoneme_consonant = p.union(
      u.assign(gr.B, ph.B),
      u.assign(gr.C, ph.CH),
      u.assign(gr.D, ph.DI),
  ...
  assign_phoneme_aspirated = p.union(
  ...
  assign_phoneme_om = u.assign(gr.OM, ph.O_L + ph.M)

  return p.union(
      assign_phoneme_vowel,
