...
_A_SGN = fl.FstList(gr.A, gr.AA).union_opt()
_A_IND = fl.FstList(gr.A_I, gr.AA_I).union_opt()
_E_SGN = fl.FstList(gr.E, gr.EE).union_opt()
_E_IND = fl.FstList(gr.E_I, gr.EE_I).union_opt()
_I_SGN = fl.FstList(gr.I, gr.II).union_opt()
_I_IND = fl.FstList(gr.I_I, gr.II_I).union_opt()
_O_IND = fl.FstList(gr.O_I, gr.OO_I).union_opt()
_U_SGN = fl.FstList(gr.U, gr.UU).union_opt()

# Nukta is frequently omitted in F and Z
_FPH = fl.FstList(gr.F, gr.PH).union_opt()
_ZJ = fl.FstList(gr.J, gr.Z).union_opt()
