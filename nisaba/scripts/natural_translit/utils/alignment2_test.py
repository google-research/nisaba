...
class AlignmentTest(test_op.TestCase):
  ...
  def test_alignment(self):
    test = alg.Alignment('test')
    self.assertEqual(test.operation, op.Operation.COMMON.unassigned)

  # def test_simple(self):
  #   simple = alg.Alignment.simple(_SYM.a, _ATM.b + _ATM.c)
  #   self.assertIsInstance(simple.left, exp.Atomic)
  #   self.assertEqual(simple.operation, op.Operation.COMMON.unassigned)
  ...
  #   )
  #   rule2 = rule1.copy()
  #   self.assertIs(alg.Alignment.ERROR.copy(), alg.Alignment.ERROR)
